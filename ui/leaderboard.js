...
export function showRoundResult(points, dist, round, maxRounds, onNext, isPerfect = false) {
...
export function showEndScreen(score, earnedXp, isTower, towerSuccess, towerFloor, onBack, perfectCoinsEarned = 0) {
    ...
    // Show XP and Perfect Coins earned
    let earnText = "+" + earnedXp + " XP";
    if (perfectCoinsEarned > 0) {
        earnText += "  |  +" + perfectCoinsEarned + " 💎";
    }
    earnEl.innerText = earnText;
